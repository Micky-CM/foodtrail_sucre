...
class RecommendationEngine:
    ...
    def _check_ambience_match(self, ambience: str, description: str) -> bool:
        ambience_keywords = {
            'romantico': ['romÃ¡ntico', 'Ã­ntimo', 'acogedor', 'especial', 'elegante'],
            'familiar': ['familiar', 'familia', 'niÃ±os', 'amplio', 'cÃ³modo'],
            'tranquilo': ['tranquilo', 'relajado', 'pacÃ­fico', 'silencioso'],
            'animado': ['animado', 'vibrante', 'activo', 'lively'],
            'moderno': ['moderno', 'contemporÃ¡neo', 'actual'],
            'tradicional': ['tradicional', 'autÃ©ntico', 'tÃ­pico', 'histÃ³rico'],
    ...
    def _check_cuisine_match(self, cuisine_type: str, establishment: Establishment) -> bool:
        ...
        cuisine_keywords = {
            'tradicional': ['tradicional', 'tÃ­pico', 'boliviana', 'chuquisaqueÃ±a', 'autÃ³ctona'],
            'moderna': ['moderna', 'contemporÃ¡nea', 'fusion', 'internacional'],
            ...
            'rapida': ['rÃ¡pida', 'fast', 'comida rÃ¡pida'],
    ...
    def _check_query_keywords(self, query: str, establishment: Establishment) -> float:
        ...
        if 'dos personas' in query or 'pareja' in query or 'cita' in query:
            if any(word in description for word in ['Ã­ntimo', 'romÃ¡ntico', 'acogedor']):
                score += 1.0
    ...
    def _format_establishment_data(self, establishment: Establishment) -> Dict[str, Any]:
        ...
        featured_menu_items = []
        menu_items = establishment.menu_items.all()[:3]
